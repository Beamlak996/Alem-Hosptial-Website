...
export const CoreValuesPage = () => {
  const words = [
    ...
    {
      text: "Values.",
      className: "text-sky-500 dark:text-blue-500",
    },
  ];
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <motion.h1
          ...
          className="text-4xl font-extrabold text-center text-sky-700 mb-8 flex items-center justify-center"
        >
          ...
          {values.map((value, index) => {
            ...
            return (
              <BentoGridItem
                ...
                icon={<IconComponent className="text-3xl text-sky-500" />}
